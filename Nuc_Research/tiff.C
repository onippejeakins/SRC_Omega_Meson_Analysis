...
TLorentzVector* pi0_p4_kin = new TLorentzVector;
...
//inputtree -> SetBranchAddress("pi0_p4_kin", &g1_p4_kin+&g2_p4_kin);
...
outputtree -> Branch("pip_p4_kin", &pip_p4_kin);
outputtree -> Branch("pim_p4_kin", &pim_p4_kin);
outputtree -> Branch("p_p4_kin", &p_p4_kin);
outputtree -> Branch("pi0_p4_kin", &pi0_p4_kin);
...
TH1D* h_beam_peak = new TH1D("beam_peak", "beam energy, counts", 100, 0, 10);
...
for(int event=0; event < n_events; event++){
	...
	*pi0_p4_kin = *g1_p4_kin + *g2_p4_kin;
